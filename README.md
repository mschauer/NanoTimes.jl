...
>  The 2018 US and EU financial regulations governing timestamps require the local time server be within 100 microsecods of UTC (an internationally coordinated time using leap seconds -- a rare 61st second introducded at the end of an hour).
