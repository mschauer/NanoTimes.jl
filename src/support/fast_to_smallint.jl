...
function str1_to_int(str::String) 
    @inbounds return Place1s[ char_to_uint(str[1]) ]
end

function str2_to_int(str::String)
    @inbounds return PlaceValue[ two_chars_to_key(str[1], str[2]) ]
end

function str3_to_int(str::String)
    @inbounds return 100 * PlaceValue[ two_chars_to_key('0', str[1]) ] +
                           PlaceValue[ two_chars_to_key(str[2], str[3]) ]
end

function str4_to_int(str::String)
    @inbounds return 100 * PlaceValue[ two_chars_to_key(str[1], str[2]) ] +
